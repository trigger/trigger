...
from trigger.changemgmt import BounceWindow

# Bounce windows for Backbone (all times US/Eastern)
BACKBONE = {
    "ABC": BounceWindow(green="0, 22-23", yellow="1-12, 19-21", red="13-18"),
    "BBQ": BounceWindow(green="3-5", yellow="0-2, 6-11", red="12-23"),
    "COW": BounceWindow(green="5-7", yellow="1-4, 8-18", red="0, 19-23"),
    "FAP": BounceWindow(green="21-23", yellow="0-12, 19-20", red="13-18"),
    "FUN": BounceWindow(green="2-4", yellow="0-1, 5-14, 21-23", red="15-20"),
    "OMG": BounceWindow(green="5-7", yellow="1-4, 8-18", red="0, 19-23"),
    "XYZ": BounceWindow(green="3-5", yellow="0-2, 6-11", red="12-23"),
}

# Bounce windows for Data Center (all times US/Eastern)
DATACENTER = {
    "ABC": BounceWindow(green="5-7", yellow="0-4, 8-15", red="16-23"),
    "BBQ": BounceWindow(green="5-7", yellow="0-4, 8-15", red="16-23"),
    "FUN": BounceWindow(green="21-23", yellow="0-12, 17-20", red="13-16"),
    "OMG": BounceWindow(green="15-18", yellow="0-4, 19-23", red="5-14"),
    "XYZ": BounceWindow(green="5-7", yellow="0-4, 8-15", red="16-23"),
}

# Out-of-band network (all times US/Eastern)
OOB = {
    "ABC": BounceWindow(green="14-17", yellow="5-13, 18-20", red="1-4, 21-23"),
    "BBQ": BounceWindow(green="14-17", yellow="18-20", red="1-13, 21-23"),
    "OMG": BounceWindow(green="14-17", yellow="5-13, 18-20", red="1-4, 21-23"),
    "XYZ": BounceWindow(green="14-17", yellow="5-13, 18-20", red="1-4, 21-23"),
}
